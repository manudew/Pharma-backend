...
exports.GET_COMPLETED_ORDERS_DETAILS = ("SELECT order_id, c.username AS customer, p.username AS pharmacy, a.address, c.contact_number FROM orders a, customer c, pharmacy p WHERE (a.customer_id=c.uid AND a.pharmacy_id=p.uid AND a.delivery_agent_id=? AND a.status='completed')")
