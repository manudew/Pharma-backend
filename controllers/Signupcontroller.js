    ...
    try {
        ...
        conn.query(CHECK_EMAIL, [req.body.email], async (err, data, feilds) => {
            ...
            if (req.body.user_type == 'Customer') {
                ...
                conn.query(REGISTER_PHARMACY, [[req.body.username, req.body.email, req.body.address, hashedValue, req.body.telephone, req.body.openTime, req.body.closeTime, null, req.body.regNo, req.body.bName, req.body.accNo, null, null, 1, otp]], (err, data, feilds) => {
                    if (err) return next(new AppError(err, 500));
                    UserController.sendSMSNotifications(req.body.contact_number,`Thank you for signing up. Here is your verification OTP: ${otp}`);
